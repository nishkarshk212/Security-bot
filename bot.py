        ...
        async with aiosqlite.connect(self.db_file) as db:
            await db.execute('''
                CREATE TABLE IF NOT EXISTS group_settings (
                    ...
                    block_poll BOOLEAN DEFAULT 0,
                    block_embed_link BOOLEAN DEFAULT 0,
            ...
            await db.execute('''
                CREATE TABLE IF NOT EXISTS approved_users (
                    ...
                    exempt_poll BOOLEAN DEFAULT 1,
                    exempt_embed_link BOOLEAN DEFAULT 1,
            ...
            new_cols = [
                ...
                ('group_settings', 'block_links', '0'),
                ('approved_users', 'exempt_links', '0')
            ]
...
class ModerationBot:
    ...
    async def cmd_help(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        help_text = style_text(
            ...
            "📊 Poll Blocking\n"
            "Block poll messages in the group\n\n"
            "🔗 Embed Link Blocking\n"
            "Block web app embed links\n\n"
    ...
    def _create_other_permissions_keyboard(self, settings):
        ...
        keyboard = [
            ...
            [
                ...
                InlineKeyboardButton(
                    f"📊 Poll: {'✅ Enabled' if settings.get('block_poll', False) else '❌ Disabled'}",
                    callback_data="toggle_block_poll"
                ),
            ],
            # Row 4: Embed Link & Links
            [
                InlineKeyboardButton(
                    f"🔗 Embed Link: {'✅ Enabled' if settings.get('block_embed_link', False) else '❌ Disabled'}",
                    callback_data="toggle_block_embed_link"
                ),
                InlineKeyboardButton(
                    f"🌐 Links: {'✅ Enabled' if settings.get('block_links', False) else '❌ Disabled'}",
    ...
    def _create_approval_keyboard(self, exemptions, user_id):
        ...
        keyboard = [
            ...
            [
                InlineKeyboardButton(
                    f"{'✅' if exemptions.get('exempt_links', False) else '❌'} 🌐 Links",
    ...
    async def callback_handler(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        if data.startswith("exempt_"):
            ...
            elif data.startswith("exempt_poll_"):
                exemption_type = "poll"
                target_user_id = int(data.replace("exempt_poll_", ""))
        ...
        if data.startswith("toggle_"):
            ...
            feature_names = {
                ...
                'block_poll': 'Poll Blocking',
                'block_embed_link': 'Embed Link Blocking',
            ...
            granular_settings = [
                'block_contacts', 'block_location', 'block_documents', 'block_voice', 'block_video_note', 'block_poll', 'block_embed_link', 'block_links'
            ]
    ...
    async def moderate_message(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        elif message.voice and settings.get('block_voice', False):
        ...
        elif message.poll and settings.get('block_poll', False):
            if not (exemptions and exemptions.get('exempt_poll', False)):
                is_media_blocked = True
        ...
        if settings.get('block_links', False):
            # Check if message text or caption contains links
